...
<body
    ...
    <div style="text-align: center; margin-bottom: 30px;">
        ...
        <p style="font-size: 16px; margin-bottom: 20px;">Hello! You have requested a two-factor authentication code</p>
        ...
        <p style="font-size: 16px; margin-bottom: 20px;">Please enter this code on the verification page to complete
            your login. <strong>This code will expire in 5 minutes.</strong></p>
    </div>
